package io.github.dtolmachev1.calculators.scientific;
        ...
        import io.github.dtolmachev1.operations.floatingpoint.FloatingPointOperationFactory;
 ...
 */
public class FloatingPointCalculator extends Calculator {
    /**
     * <p>Default constructor to initialize calculator.</p>
     */
    public FloatingPointCalculator() {
        this.operationFactory = new FloatingPointOperationFactory();
    }
